...
int main(){
    ...
    string expression2 = "2-4+3/6+5*7^2";

    // converting to postfix
    string pf = infixToPostfix(expression1);
    cout<<pf<<endl;
    cout<<calculate(pf)<<endl<<endl;

    pf = infixToPostfix(expression);
    cout<<pf<<endl;
    cout<<calculate(pf)<<endl<<endl;

    pf = infixToPostfix(expression2);
    cout<<pf<<endl;
    cout<<calculate(pf)<<endl<<endl;
    return 0;
}
