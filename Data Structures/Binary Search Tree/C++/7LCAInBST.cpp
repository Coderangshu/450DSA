...
Node* LCA1(Node * root , int l , int h);
...
Node* LCA(Node *root, int n1, int n2)
{
    ...
    // This is returned when one of n1 and n2 is smaller
    // than the root thus implying that the root is the
    // LCA of n1 and n2
    return root;
}
