...
// The concept used here is we traverse the BST in inorder
// and store it in an array, then we again traverse the 
// tree in preorder way, and insert the data from the inorder
// array into the nodes as traversed by preorder
