...
class Solution{
  public:
      // Two trees are called isomorphic if one can be obtained from 
      ...
      bool isIsomorphic(Node *root1,Node *root2){
          ...
          // If data of both tree don't match return false
          if (root1->data != root2->data) return false;
            
          // There are two possible cases for root1 and root2 to be isomorphic
          // Case 1: The subtrees rooted at these nodes have NOT been "Flipped".
          // Both of these subtrees have to be isomorphic, hence the "and"
          // Case 2: The subtrees rooted at these nodes have been "Flipped"
          // Any of the 2 cases can be true for isomorphic tree thus the "or"
          return 
