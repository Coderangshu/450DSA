...
// Here we use Interval tree to store the intervals, this tree is 
// a kind of Binary Search tree, wherein the intervals are place
// w.r.t. to their lower value and the upper values of each element
// are reflected in their parent, i.e. the max of the complete subtree
// both left and right is reflected in the root.
